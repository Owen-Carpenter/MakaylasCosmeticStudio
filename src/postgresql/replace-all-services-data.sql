-- =====================================================
-- REPLACE ALL SERVICES DATA - CLEAN SLATE
-- =====================================================
-- This script completely replaces all services data
-- Removes duplicates and inserts clean service variants
-- =====================================================

-- Step 1: Clear all existing services and variants
DELETE FROM service_variants;
DELETE FROM services;

-- Reset sequences if they exist
SELECT setval(pg_get_serial_sequence('services', 'id'), 1, false);

-- Step 2: Insert clean services data
...
-- BROW SERVICES
('Brow Wax (no shaping)', 'A quick brow clean up (does not include shaping). Last 2-4 weeks.', '15 min', 'brows', 10.00, false),
('Brow Wax (with shaping)', 'A brow wax that includes mapping and shaping of the brows. Last 2-4 weeks.', '25 min', 'brows', 17.00, false),
('Brow Tint', 'Tinting of the brows.', '30 min', 'brows', 30.00, false),
('Brow Tint & Wax (with shaping)', 'Tinting and waxing of the brows that comes with mapping/shaping leaving you with the best eyebrow shape for you.', '45 min', 'brows', 37.00, false),
('Brow Lamination', 'Process of "perming" your brow hairs, but instead of curls, you get straighter, slightly upward or feathered (depending on your wants) that are set in place. Brow laminations comes with the whole package: lamination, tint, and wax (with shaping).', '60 min', 'brows', 75.00, false),
...
-- Step 3: Insert service variants for eyelash extension services
...
BEGIN
    ...
    SELECT COUNT(*) INTO variant_count FROM service_variants;
    
    RAISE NOTICE '==============================================';
    RAISE NOTICE 'ALL SERVICES DATA REPLACED SUCCESSFULLY';
    RAISE NOTICE '==============================================';
    RAISE NOTICE 'Total services: %', service_count;
    RAISE NOTICE 'Total service variants: %', variant_count;
    RAISE NOTICE 'Lash services with variants: 6';
    RAISE NOTICE 'Other services: %', service_count - 6;
    RAISE NOTICE 'Categories: Lashes, Brows, Facials, Waxing';
    RAISE NOTICE '==============================================';
    RAISE NOTICE 'All duplicate services have been removed!';
    RAISE NOTICE '==============================================';
END $$; 